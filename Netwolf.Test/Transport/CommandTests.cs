...
public class CommandTests
{
    ...
    static IEnumerable<object?[]> TestCommandParseData =>
        new[]
        {
            new object?[] { "foo bar baz asdf", null, "FOO", new string[] { "bar", "baz", "asdf" }, null },
            new object?[] { ":coolguy foo bar baz asdf", "coolguy", "FOO", new string[] { "bar", "baz", "asdf" }, null },
            new object?[] { "foo bar baz :asdf quux", null, "FOO", new string[] { "bar", "baz", "asdf quux" }, null },
            new object?[] { "foo bar baz :", null, "FOO", new string[] { "bar", "baz", "" }, null },
            new object?[] { "foo bar baz ::asdf", null, "FOO", new string[] { "bar", "baz", ":asdf" }, null },
            new object?[] { ":coolguy foo bar baz :asdf quux", "coolguy", "FOO", new string[] { "bar", "baz", "asdf quux" }, null },
            new object?[] { ":coolguy foo bar baz :  asdf quux ", "coolguy", "FOO", new string[] { "bar", "baz", "  asdf quux " }, null },
            new object?[] { ":coolguy PRIVMSG bar :lol :) ", "coolguy", "PRIVMSG", new string[] { "bar", "lol :) " }, null },
            new object?[] { ":coolguy foo bar baz :", "coolguy", "FOO", new string[] { "bar", "baz", "" }, null },
            new object?[] { ":coolguy foo bar baz :  ", "coolguy", "FOO", new string[] { "bar", "baz", "  " }, null },
            new object?[] { "@a=b;c=32;k;rt=ql7 foo", null, "FOO", Array.Empty<string>(), new { a = "b", c = "32", k = NoValue, rt = "ql7" } },
            ...
            new object?[] { "@c;h=;a=b :quux ab cd", "quux", "AB", new string[] { "cd" }, new { c = NoValue, h = NoValue, a = "b" } },
            // different forms of last param
            new object?[] { ":src JOIN #chan", "src", "JOIN", new string[] { "#chan" }, null },
            new object?[] { ":src JOIN :#chan", "src", "JOIN", new string[] { "#chan" }, null },
            // with and without last param
            new object?[] { ":src AWAY", "src", "AWAY", Array.Empty<string>(), null },
            new object?[] { ":src AWAY ", "src", "AWAY", Array.Empty<string>(), null },
            new object?[] { ":cool\tguy foo bar baz", "cool\tguy", "FOO", new string[] { "bar", "baz" }, null },
            ...
            new object?[] { ":irc.example.com COMMAND param1 param2 :param3 param3", "irc.example.com", "COMMAND", new string[] { "param1", "param2", "param3 param3" }, null },
            new object?[]
            {
            ...
            new object?[] { ":gravel.mozilla.org MODE #tckk +n ", "gravel.mozilla.org", "MODE", new string[] { "#tckk", "+n" }, null },
            new object?[] { ":services.esper.net MODE #foo-bar +o foobar  ", "services.esper.net", "MODE", new string[] { "#foo-bar", "+o", "foobar" }, null },
            // tag values should be parsed char-at-a-time to prevent wayward replacements.
            new object?[] { "@tag1=value\\\\ntest COMMAND", null, "COMMAND", Array.Empty<string>(), new { tag1 = "value\\ntest" } },
            // If a tag value has a slash followed by a character which doesn't need to be escaped, the slash should be dropped.
            new object?[] { "@tag1=value\\1 COMMAND", null, "COMMAND", Array.Empty<string>(), new { tag1 = "value1" } },
            // A slash at the end of a tag value should be dropped
            new object?[] { "@tag1=value1\\ COMMAND", null, "COMMAND", Array.Empty<string>(), new { tag1 = "value1" } },
            // Duplicate tags: Parsers SHOULD disregard all but the final occurence
            new object?[] { "@tag1=1;tag2=3;tag3=4;tag1=5 COMMAND", null, "COMMAND", Array.Empty<string>(), new { tag1 = "5", tag2 = "3", tag3 = "4" } },
            ...
            new object?[] { ":SomeOp MODE #channel :+i", "SomeOp", "MODE", new string[] { "#channel", "+i" }, null },
            new object?[] { ":SomeOp MODE #channel +oo SomeUser :AnotherUser", "SomeOp", "MODE", new string[] { "#channel", "+oo", "SomeUser", "AnotherUser" }, null },
        };
